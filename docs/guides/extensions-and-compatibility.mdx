...
The report validator and replay correction on this page are **development
changes after 0.18.0**. Pin a released version for deployments; use a specific
Git commit when evaluating unreleased integrations.
