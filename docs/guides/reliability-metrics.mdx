...
description: Capability vs consistency from the same multi-run data — unbiased estimators, cluster-bootstrap CIs, and a CI-lower-bound gate.
---
...
| **pass^k** | "Do all k trials succeed?" | Consistency — what a user hitting this feature k times experiences |
