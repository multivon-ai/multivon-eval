...
**Development branch: not included in PyPI 0.17.0.** Tested with Inspect 0.3.263
...
for `eval_retry`, native request logging, and sample preservation. A deliberate
kill/restart experiment for this bridge remains part of our validation program;
the example above does not demonstrate crash recovery.
