...
This uses the same versioned policy as the eval-action v2 branch and
`eval_acceptance_report` in the multivon-mcp 0.4 branch. Check the companion
release notes for availability. The policy returns accept/reject/indeterminate
