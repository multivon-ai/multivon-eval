---
title: Generate QA cases from docs
description: Turn your documentation, knowledge base, or any text into ready-to-run question-answer eval cases — no labeled data required.
---

The hardest part of getting started with evals is having nothing to evaluate against. `generate_from_file()` removes that: point it at your documentation, knowledge base, or any text and get ready-to-run eval cases in seconds.

<Note>
This page covers generating QA cases from source text. For the full
generation toolkit — mutations, template grids, contrast pairs, and
simulation transcripts — see [Synthetic dataset
generation](/guides/synthetic-data).
</Note>
