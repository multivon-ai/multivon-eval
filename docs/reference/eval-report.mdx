...
| `total_cost_usd` | `float \| None` | Estimate from recorded usage and bundled pricing; `None` if a recorded model lacks pricing. Excludes your model-under-test costs. |
