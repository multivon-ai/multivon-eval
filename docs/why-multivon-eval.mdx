...
- **Regulated AI**: hash-chained NDJSON audit logs with paragraph-accurate EU AI Act / NIST AI RMF / HIPAA mappings. `audit-package` produces an auditor-attachable zip — [download a real sample (5.5 KB)](https://github.com/multivon-ai/multivon-eval/raw/main/docs/sample-audit-package.zip).
