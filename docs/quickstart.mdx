...
Returns four files: `eval_suite.py` (runnable), `seed_cases.jsonl` (30 adversarial cases), `thresholds.yaml` (calibrated from your traces), and `DISCOVERY_REPORT.md` (an eval design review). Cost: ~$0.01 per bootstrap. **[Full walkthrough →](/guides/bootstrap)**
