...
evaluator = VQAFaithfulness(judge=JudgeConfig(
    provider="google", model="gemini-2.5-flash", temperature=0.0,
))
result = evaluator.evaluate(case, "The scan shows bilateral infiltrates...")
```
...
evaluator = DocumentGrounding(judge=JudgeConfig(
