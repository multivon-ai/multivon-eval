...
| R14 | Research contribution/popularization | Related-work comparison, bounded novelty statement, reproducibility bundle, diagrams when useful, worked demo and evidence-led website narrative | In progress: [regulated-enterprise target/moat study](regulated-enterprise-study.md) and [public benchmark program](sota-benchmark-program.md) researched; TAT-QA files audited; [native RAGChecker reproduction](../benchmarks/industrial/results/ragchecker-meta-2026-09-17/README.md) matches published correlations on 280 cases. No Multivon meta-evaluation result or SoTA claim yet |
