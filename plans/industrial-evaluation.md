...
| R12 | FOSS extension/stability contract | Public plugin/environment protocols, versioned report schemas, optional heavy dependencies, contributor fixtures, compatibility matrix and release checks | Development: contracts/replay/schema/migration fixes pushed at 6d99655; clean wheels checked on Python 3.10/3.12. CI improvements saved at local 2eccb5f; GitHub rejects workflow changes without workflow-scoped credentials. Broader dependency combinations remain to verify. See [compatibility audit](foss-compatibility.md) |
| R13 | Industrial workflow and experiments | Document-to-ledger task, independent assertions, failures/benign controls, matched-budget baselines, held-out splits, actual provider runs, costs and uncertainty; results critique | Public engineering evidence delivered: CORD/pdfhell study on 39 held-out sources plus a complete 1,663-question TAT-QA paired prompt study with official scoring, provider evidence, cost and context-bootstrap uncertainty. Joint evidence generation significantly reduced answer quality and increased cost; customer-domain contract validation remains |
| R14 | Research contribution/popularization | Related-work comparison, bounded novelty statement, reproducibility bundle, diagrams when useful, worked demo and evidence-led website narrative | In progress: [regulated-enterprise study](regulated-enterprise-study.md), [full TAT-QA financial evidence study](../benchmarks/industrial/results/tatqa-financial-2026-09-17/README.md), [native RAGChecker reproduction](../benchmarks/industrial/results/ragchecker-meta-2026-09-17/README.md) and [full same-model judge study](../benchmarks/industrial/results/ragchecker-judges-2026-09-17/README.md). Evidence supports separating answer generation from evidence binding; no SoTA, generic-QAG moat or customer-validity claim demonstrated |
...
| R16 | Library/docs/site delivery | Cohesive API/migrations, runnable docs, visual website checks, supported-Python tests, packaging, verified pushes/releases, no overstated claims | Delivered for 0.19.0: Faithfulness coverage fixes, provider evidence, declared execution contracts, report schema/migrations and experimental adapters published to PyPI and GitHub; clean Python 3.10/3.12 installs, public docs and the live website verified. Broader production claims remain gated by R17 |
...
2026-09-17 TAT-QA result: completed 554 context/treatment calls covering all
1,663 released test-gold questions. Answer-only reached 74.74% EM and 82.76%
F1; joint answer-plus-evidence reached 72.22% and 79.96%. Paired context-bootstrap
intervals exclude zero in the negative direction. The joint treatment increased
estimated cost 41.70% and median latency 35.24%. It produced 99.58% valid
locations but only 55.20% strict answer-plus-full-annotation-location acceptance.
One HTTP-200 context omitted five of six required IDs and remains six zero-score
questions. No provider transport or capture gaps occurred in the corrected run.
The result rejects the tested joint-generation design; a decoupled evidence
binder is a post-result hypothesis, not a demonstrated improvement. Public-label
contamination, mutable model alias, alternate evidence and missing customer
validation remain explicit limitations.
...
177 passed. All 73 MDX pages parse. The fix shipped in 0.19.0.

2026-09-17 release: published multivon-eval 0.19.0 to PyPI and GitHub from
commit 12181bf. The wheel and source archive passed Twine checks, their PyPI
hashes matched the locally built artifacts, and the source archive rebuilt and
installed cleanly on Python 3.10 and 3.12. The 0.19 migration guide is live at
docs.multivon.ai, and multivon.ai serves the updated 0.19.0 release snapshot.
